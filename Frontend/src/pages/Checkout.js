...
const Checkout = () => {
        ...
        <div className='row'>
          <div className='col-7'>
            <div className='checkout-left-data'>
              ...
              <p className='user-details total'>Dev A2K (ntkiet11082002@gmail.com)</p>
  ...
  <div className='error ms-2 my-1'>{formik.touched.state && formik.errors.state}</div>
          ...
          <div className='col-5'>
                ...
                cartState?.map((item, index) => {
                  return (
                    <div key={index} className='d-flex gap-10 mb-2 align-align-items-center'>
                      ...
                      <div className='flex-grow-1'>
                        <h5 className='total'>{(item?.price * item?.quantity).toLocaleString('vi-VN')}₫</h5>
                      </div>
                    </div>
                  );
                })}
            ...
            <div className='border-bottom py-4'>
              <div className='d-flex justify-content-between align-items-center'>
                ...
                <p className='total-price'>{totalAmount ? totalAmount.toLocaleString('vi-VN') : '0'}₫</p>
              </div>
              {totalAmount < 1000000 && (
                <div className='d-flex flex-column py-2'>
                  ...
                  <div className='form-check'>
                    <input
                      ...
                      onChange={() => handleShippingMethodChange(15000, 'economy')}
                    />
                  ...
                  <div className='form-check'>
                    <input
                      ...
                      onChange={() => handleShippingMethodChange(30000, 'standard')}
                    />
                  ...
                  <div className='form-check'>
                    <input
                      ...
                      onChange={() => handleShippingMethodChange(60000, 'express')}
                    />
              ...
              <div className='d-flex justify-content-between align-items-center'>
                ...
                <p className='mb-0 total-price'>{discountAmount.toLocaleString('vi-VN')}₫</p>
              </div>
            </div>
            <div className='d-flex justify-content-between align-items-center border-bottom py-4'>
              ...
              <h5 className='total-price'>
                {totalAmount
                  ? (totalAmount + (totalAmount >= 1000000 ? 0 : shippingCost) - discountAmount).toLocaleString(
                      'vi-VN'
                    )
                  : '0'}
                ₫
            ...
            <div className='border-bottom py-4'>
              <div className='d-flex flex-column'>
                ...
                <button className='button mt-2' onClick={() => setShowModal(true)}>
                  Chọn mã giảm giá
                </button>
              </div>
            </div>
      ...
      <DiscountCodeModal show={showModal} handleClose={() => setShowModal(false)} handleSelectCode={handleSelectCode} />
    </>
  );
};
